      ...
      <div className="mx-auto flex min-h-[calc(100vh-3rem)] w-full max-w-6xl items-center justify-center">
        <section className="grid w-full overflow-hidden rounded-lg border border-gray-200 bg-card shadow-sm dark:border-gray-800 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="relative hidden bg-[#060d1c] p-10 text-white lg:block">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(139,92,246,0.28),transparent_32%),radial-gradient(circle_at_80%_70%,rgba(16,185,129,0.18),transparent_30%)]" />
            <div className="relative flex h-full flex-col justify-between">
              ...
              <div>
                <p className="text-sm font-bold uppercase tracking-[0.22em] text-emerald-300">One graph. All your code.</p>
